...
public class TeamJpaServiceTest {
	...
	public void findByKey_Found_FromDate() {
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("harlem-globetrotter's", new LocalDate(2009, 7, 1));
	...
	public void findByKey_Found_ToDate() {
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("harlem-globetrotter's", new LocalDate(2010, 6, 30));
		Assert.assertEquals("Harlem Globetrotter's", team.getFullName());
		Assert.assertTrue(team.isFound());
	}
	...
	public void findByKey_NotFound_TeamKey() {
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("harlem-hooper's", new LocalDate(2009, 7, 1));
		Assert.assertTrue(team.isNotFound());
	}

	@Test
	public void findByKey_NotFound_BeforeAsOfDate() {
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("harlem-globetrotter's", new LocalDate(2009, 6, 30));
		Assert.assertTrue(team.isNotFound());
	}

	@Test
	public void findByKey_NotFound_AfterAsOfDate() {
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("harlem-globetrotter's", new LocalDate(2010, 7, 1));
		Assert.assertTrue(team.isNotFound());
	}

	@Test
	public void findByLastName_Found_FromDate() {
		Team team = teamJpaService.findByLastNameAndAsOfDate("Globetrotter's", new LocalDate(2009, 7, 1));
		Assert.assertEquals("Harlem Globetrotter's", team.getFullName());
		Assert.assertTrue(team.isFound());
	}
	...
	public void findByLastName_Found_ToDate() {
		Team team = teamJpaService.findByLastNameAndAsOfDate("Globetrotter's", new LocalDate(2010, 6, 30));
		Assert.assertEquals("Harlem Globetrotter's", team.getFullName());
		Assert.assertTrue(team.isFound());
	}
	...
	public void findByLastName_NotFound_TeamKey() {
		Team team = teamJpaService.findByLastNameAndAsOfDate("Globetreker's", new LocalDate(2009, 7, 1));
		Assert.assertTrue(team.isNotFound());
	}

	@Test
	public void findByLastName_NotFound_BeforeAsOfDate() {
		Team team = teamJpaService.findByLastNameAndAsOfDate("Globetrotter's", new LocalDate(2009, 6, 30));
		Assert.assertTrue(team.isNotFound());
	}

	@Test
	public void findByLastName_NotFound_AfterAsOfDate() {
		Team team = teamJpaService.findByLastNameAndAsOfDate("Globetrotter's", new LocalDate(2010, 7, 1));
		Assert.assertTrue(team.isNotFound());
	}
	...
	public void findByDateRange_Found() {
		List<Team> teams = teamJpaService.findByDate(new LocalDate(2009, 10, 30));
		Assert.assertTrue(teams.size() >= 4);
	}

	@Test
	public void findByDateRange_NotFound() {
		List<Team> teams = teamJpaService.findByDate(new LocalDate(1909, 10, 30));
		Assert.assertEquals(0, teams.size());
	}

	@Test
	public void create_Created_AsOfDate() {
		Team createTeam = teamJpaService.create(createMockTeam("sacramento-hornets", new LocalDate(2012, 7, 1), new LocalDate(9999, 12, 31), "Sacramento Hornets"));
		Team findTeam = teamJpaService.findByTeamKeyAndAsOfDate("sacramento-hornets", new LocalDate(2012, 7, 1));
	...
	public void create_Created_DateRange() {
		Team createTeam = teamJpaService.create(createMockTeam("sacramento-rivercats", new LocalDate(2006, 7, 1), new LocalDate(2012, 7, 2), "Sacramento Rivercats"));
		Team findTeam = teamJpaService.findByTeamKeyAndAsOfDate("sacramento-rivercats", new LocalDate(2006, 7, 1));
		Assert.assertTrue(createTeam.isCreated());
	...
	public void create_OverlappingDates() {
		Team createTeam = teamJpaService.create(createMockTeam("cleveland-rebels", new LocalDate(2010, 7, 1), new LocalDate(2010, 7, 1), "Cleveland Rebels"));
		Assert.assertTrue(createTeam.isFound());
	}

	@Test(expected=DataIntegrityViolationException.class)
	public void create_MissingRequiredData() {
		Team createTeam = teamJpaService.create(createMockTeam("chavo-del-ocho", new LocalDate(2010, 7, 1), new LocalDate(2010, 7, 1), null));
	}

	@Test
	public void update_Updated() {
		Team updateTeam = teamJpaService.update(createMockTeam("st-louis-bomber's", new LocalDate(2009, 7, 1), new LocalDate(9999, 12, 31), "St. Louis Bombier's"));
		Team team = teamJpaService.findByTeamKeyAndAsOfDate("st-louis-bomber's", new LocalDate(9999, 12, 31));
	...
	public void update_NotFound() {
		Team team = teamJpaService.update(createMockTeam("st-louis-bomb's", new LocalDate(2009, 7, 1), new LocalDate(2010, 7, 1), "St. Louis Bombier's"));
		Assert.assertTrue(team.isNotFound());
	}

	@Test(expected=DataIntegrityViolationException.class)
	public void update_MissingRequiredData() {
		teamJpaService.update(createMockTeam("st-louis-bomber's", new LocalDate(2009, 7, 1), new LocalDate(2010, 6, 30), null));
	}
